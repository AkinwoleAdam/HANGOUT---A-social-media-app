    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follows', models.ManyToManyField(blank=True, related_name='followed_by', to='room.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comments', to='room.post')),
